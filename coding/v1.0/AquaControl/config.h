...
// ── MQTT ────────────────────────────────────────────────────
// Private HiveMQ Cloud broker — TLS required, authenticated. Credentials
// live in mqtt_secrets.h (gitignored — copy mqtt_secrets.h.example and
// fill in your own) so they never end up in the public repo.
//
...
#define MQTT_BROKER                 "72e938bbd0584b6da26179a77a8b499d.s1.eu.hivemq.cloud"
