...
export const topicCommands = (deviceId: string) => `${TOPIC_PREFIX}/${deviceId}/commands`

// Must match FCM_TOPIC in the mqtt-fcm-relay service.
export const FCM_TOPIC = 'aquacontrol_alerts'
export const NOTIFICATION_CHANNEL_ID = 'aquacontrol-alerts'

export const HISTORY_KEY = 'aquacontrol_history'
export const ALERTS_KEY = 'aquacontrol_alerts_log'
...
// the device's own clock instead of plotting it at the 1970 origin.
